...
install_name_tool -change /usr/local/Cellar/ffmpeg/3.2/lib/libavcodec.57.dylib @executable_path/../Frameworks/libavcodec.57.dylib ./Frameworks/libavformat.57.dylib
